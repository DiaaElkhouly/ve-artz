    ...
    <>
      ...
      <main className="pt-16">
        ...
        >
          ...
          <p className="text-xs uppercase tracking-[0.35em] text-[color:var(--text-muted)] text-center">
            {isArabic ? "عملاؤنا" : "Our Clients"}
          </p>
          {/* Main heading with language-specific text */}
          <h2 className="mt-3 text-4xl font-semibold text-[color:var(--text)] md:text-5xl text-center">
